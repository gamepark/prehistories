...
const PrehistoriesTutorial: TutorialDescription<GameState, Move, PlayerColor> = {
    ...
    expectedMoves:()=> [
        ...
        {type:MoveType.TellYouAreReady,playerId:PlayerColor.White},
            // Hunt
        {type:MoveType.PlaceTile,coordinates:{x:0,y:1},side:0,huntSpot:0},
        {type:MoveType.SpendHunter,card:6},
        {type:MoveType.EndTurn},
        {type:MoveType.EndTurn},
        {type:MoveType.PlaceTile,coordinates:{x:0,y:6},side:0,huntSpot:1},
        {type:MoveType.SpendHunter,card:6},
        ...
        // Turn 2
            // Initiative
        [{type:MoveType.PlayHuntCard,playerId:PlayerColor.Yellow,card:2},
         {type:MoveType.PlayHuntCard,playerId:PlayerColor.Yellow,card:3},
         {type:MoveType.PlayHuntCard,playerId:PlayerColor.Yellow,card:4},
         {type:MoveType.PlayHuntCard,playerId:PlayerColor.Yellow,card:8}],
        [{type:MoveType.PlayHuntCard,playerId:PlayerColor.Yellow,card:2},
         {type:MoveType.PlayHuntCard,playerId:PlayerColor.Yellow,card:3},
         {type:MoveType.PlayHuntCard,playerId:PlayerColor.Yellow,card:4},
         {type:MoveType.PlayHuntCard,playerId:PlayerColor.Yellow,card:8}],
        ...
        [{type:MoveType.PlayHuntCard,playerId:PlayerColor.Yellow,card:2},
         ...
         {type:MoveType.PlayHuntCard,playerId:PlayerColor.Yellow,card:8}],
         {type:MoveType.TellYouAreReady,playerId:PlayerColor.Yellow},
         {type:MoveType.PlayHuntCard,playerId:PlayerColor.Green,card:11},
         {type:MoveType.PlayHuntCard,playerId:PlayerColor.Green,card:0},
         {type:MoveType.TellYouAreReady,playerId:PlayerColor.Green},
         {type:MoveType.PlayHuntCard,playerId:PlayerColor.White,card:0},
         {type:MoveType.PlayHuntCard,playerId:PlayerColor.White,card:2},
         {type:MoveType.PlayHuntCard,playerId:PlayerColor.White,card:4},
         {type:MoveType.TellYouAreReady,playerId:PlayerColor.White},
             // Hunt
         {type:MoveType.PlaceTile,coordinates:{x:0,y:5},side:0,huntSpot:0},
         {type:MoveType.SpendHunter,card:4},
         {type:MoveType.SpendHunter,card:2},
         {type:MoveType.EndTurn},
         {type:MoveType.PlaceTile,coordinates:{x:2,y:5},side:0,huntSpot:2},
         {type:MoveType.SpendHunter,card:0},
         {type:MoveType.SpendHunter,card:11},
         {type:MoveType.ValidateSpentHunters},
         {type:MoveType.EndTurn},
         {type:MoveType.PlaceTile,coordinates:{x:2,y:1},side:1,huntSpot:1},
         [{type:MoveType.SpendHunter,card:2},
        ...
        [{type:MoveType.PlayHuntCard,playerId:PlayerColor.Yellow,card:8},
        {type:MoveType.PlayHuntCard,playerId:PlayerColor.Yellow,card:4},
        {type:MoveType.PlayHuntCard,playerId:PlayerColor.Yellow,card:10}],
        [{type:MoveType.PlayHuntCard,playerId:PlayerColor.Yellow,card:8},
        {type:MoveType.PlayHuntCard,playerId:PlayerColor.Yellow,card:4},
        {type:MoveType.PlayHuntCard,playerId:PlayerColor.Yellow,card:10}],
        [{type:MoveType.PlayHuntCard,playerId:PlayerColor.Yellow,card:8},
        ...
        {type:MoveType.PlayHuntCard,playerId:PlayerColor.Yellow,card:10}],
        {type:MoveType.TellYouAreReady,playerId:PlayerColor.Yellow},
        {type:MoveType.PlayHuntCard,playerId:PlayerColor.Green,card:4},
        {type:MoveType.PlayHuntCard,playerId:PlayerColor.Green,card:1},
        {type:MoveType.TellYouAreReady,playerId:PlayerColor.Green},
        {type:MoveType.PlayHuntCard,playerId:PlayerColor.White,card:0},
        {type:MoveType.PlayHuntCard,playerId:PlayerColor.White,card:3},
        {type:MoveType.PlayHuntCard,playerId:PlayerColor.White,card:5},
        {type:MoveType.PlayHuntCard,playerId:PlayerColor.White,card:6},
        {type:MoveType.PlayHuntCard,playerId:PlayerColor.White,card:10},
        {type:MoveType.PlayHuntCard,playerId:PlayerColor.White,card:11},
        {type:MoveType.TellYouAreReady,playerId:PlayerColor.White},
            // Hunt
            {type:MoveType.PlaceTile,coordinates:{x:4,y:6},side:0,huntSpot:0},
            {type:MoveType.SpendHunter,card:1},
            {type:MoveType.SpendHunter,card:4},
            {type:MoveType.EndTurn},
            {type:MoveType.PlaceTile,coordinates:{x:3,y:3},side:0,huntSpot:4},
            [{type:MoveType.SpendHunter,card:4},
            ...
            {type:MoveType.ValidateSpentHunters},
            {type:MoveType.EndTurn},
            {type:MoveType.PlaceTile,coordinates:{x:1,y:4},side:0,huntSpot:2},
            {type:MoveType.SpendHunter,card:10},
            {type:MoveType.SpendHunter,card:6},
            {type:MoveType.EndTurn},
