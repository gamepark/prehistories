...
import {resolvePermanentGoals} from '@gamepark/prehistories/moves/CheckPermanentGoals'
import {resolveVariableGoals} from '@gamepark/prehistories/moves/CheckVariableGoals'
