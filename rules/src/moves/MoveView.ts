...
type MoveView = Exclude<Move, RevealHuntCards | RefillHuntingBoard | ShuffleDiscardPile> | PlayHuntCardView | RevealHuntCardsView | RefillHuntingBoardView | TakeBackPlayedCardsView | DrawXCardsView | ShuffleDiscardPileView
